  ...
  return (
    <div className="home-screen">
      <header className="header">
        ...
        <nav>
        <button className="btn-login" onClick={navigateToLogInScreen}>Login</button>
          <button className="btn-explore" onClick={navigateToPlaygroundScreen1}>
            Explore
          </button>
        </nav>
      </header>
      ...
      <div className="hero-section">
        ...
        <div className="hero-buttons">
          <button className="btn-explore-guest" onClick={navigateToPlaygroundScreen1}>
            Explore as Guest
          </button>
          <button className="btn-signup" onClick={navigateToLogInScreen}>
            Sign Up for Free
          </button>
        </div>
      </div>
